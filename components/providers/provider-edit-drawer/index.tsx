...
import { useProviderEditState, useTabSearch } from "@/lib/hooks/use-provider-edit-state"
...
import { DeleteConfirmation, UnsavedChangesDialog } from "./confirmation-dialog"
      ...
      <div className="absolute right-0 top-0 bottom-0 w-full max-w-7xl bg-white shadow-2xl flex flex-col animate-in slide-in-from-right duration-400">
        ...
        <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 flex items-center justify-between">
          <div className="text-xs text-gray-500">
            <kbd className="px-1.5 py-0.5 bg-gray-200 rounded text-gray-600">Ctrl+S</kbd> to save •{" "}
            <kbd className="px-1.5 py-0.5 bg-gray-200 rounded text-gray-600">Esc</kbd> to close
          </div>
